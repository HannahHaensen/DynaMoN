...
from NeRF.nerf.model.mlp import General_MLP
from NeRF.nerf.model.sh import eval_sh_bases
...
class HexPlane_Base(torch.nn.Module):
    ...
    def compute_densityfeature_grad(self, xyz_sampled, frame_time):
        pass

    def compute_appfeature(self, xyz_sampled, frame_time):
        pass

    def compute_appfeature_grad(self, xyz_sampled, frame_time):
        pass
